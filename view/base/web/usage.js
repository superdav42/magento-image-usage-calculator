    ...
    $.widget('mage.usage', {
        ...
        _create: function () {
            ...
            if ( this.options.selectedCategory ) {
                for (const [key, value] of Object.entries(this.options.selectedOptions)) {
                    self.element.find('[name=options\\[' + key + '\\]]')
                        .val(value)
                        .show()
                        .prop('disabled', false)
                        .change()
                ...
                self.element.find('[name=usage_category]').val(this.options.selectedCategory);
                for (const [key, value] of Object.entries(this.options.selectedUsage)) {
                    self.element.find('[name=usage_id\\[' + key + '\\]]')
                        .val(value)
                        .show()
                        .prop('disabled', false)
                        .change()
