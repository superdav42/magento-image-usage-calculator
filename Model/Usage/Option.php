...
use DevStone\UsageCalculator\Api\Data\UsageCustomOptionValuesInterface;
use DevStone\UsageCalculator\Model\Usage;
use DevStone\UsageCalculator\Model\ResourceModel\Usage\Option\Value\Collection;
 ...
 *
 * @api
 * @method int getUsageId()
 * @method \DevStone\UsageCalculator\Model\Usage\Option setUsageId(int $value)
 *
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects)
 * @SuppressWarnings(PHPMD.ExcessivePublicCount)
 */
class Option extends AbstractExtensibleModel implements UsageCustomOptionInterface
{
    /**
     ...
     * Constants
     */
    const KEY_PRODUCT_SKU = 'usage_id';
    ...
    public function groupFactory($type)
    {
        ...
        if (!empty($group)) {
            return $this->optionTypeFactory->create(
                'DevStone\UsageCalculator\Model\Usage\Option\Type\\' . $this->string->upperCaseWords($group)
            );
        }
    ...
    public function getPrice($flag = false)
    {
        if ($flag && $this->getPriceType() == self::$typePercent) {
            $basePrice = $this->getUsage()->getPrice();
    ...
    /**
     * Get Usage Option Collection
     *
     * @param Usage $product
     * @return \DevStone\UsageCalculator\Model\ResourceModel\Usage\Option\Collection
     */
    public function getUsageOptions(Usage $product)
    {
        return $this->getOptionRepository()->getUsageOptions($product, $this->getAddRequiredFilter());
    }
     ...
     */
    public function getUsageOptionCollection(Usage $usage)
    {
        ...
        $collection->addValuesToResult($usage->getStoreId());
        return $collection;
    }
    ...
    private function getOptionRepository()
    {
        if (null === $this->optionRepository) {
            $this->optionRepository = \Magento\Framework\App\ObjectManager::getInstance()
                ->get(\DevStone\UsageCalculator\Model\Usage\Option\Repository::class);
        }
