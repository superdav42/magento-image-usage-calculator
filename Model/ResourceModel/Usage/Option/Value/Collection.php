...
namespace DevStone\UsageCalculator\Model\ResourceModel\Usage\Option\Value;

/**
 * Usage option values collection
 *
 * @api
 */
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        $this->_init(
            \DevStone\UsageCalculator\Model\Usage\Option\Value::class,
            \DevStone\UsageCalculator\Model\ResourceModel\Usage\Option\Value::class
        );
    }
     ...
     *
     * @param array|\DevStone\UsageCalculator\Model\Usage\Option|int $option
     * @return $this
     */
    public function addOptionToFilter($option)
    {
        ...
        } elseif ($option instanceof \DevStone\UsageCalculator\Model\Usage\Option) {
