...
namespace DevStone\UsageCalculator\Model\ResourceModel\Eav;
...
class Attribute extends EavAttribute implements ScopedAttributeInterface
{
     ...
     * Constants
     */
    const MODULE_NAME = 'DevStone_Usage';
     ...
     * @var string
     */
    protected $_eventPrefix = UsageSetup::ENTITY_TYPE_CODE . '_entity_attribute';
